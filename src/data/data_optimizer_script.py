...
def optimize_chunk(chunk,i,original_data_size,new_data_size):
    ...
    sample_data.to_pickle("../../data/processed/memory_optimized_data"+str(i)+".pkl")

    original_data_size+=initial_memory_usage
    new_data_size+=final_memory_usage

    return original_data_size,new_data_size
...
for chunk in pd.read_csv("../../data/raw/train.csv", chunksize=chunksize):
    ...
    print(i)
    print(chunk.head())
    original_data_size, new_data_size=optimize_chunk(chunk,i,original_data_size,new_data_size)
